describe "tasksController", ->
    ...
    describe "TasksViewController", ->
        ...
        beforeEach(inject(($rootScope, $controller, $httpBackend, $q) ->
            ...
            httpBackend.whenGET("#{APIURL}/tasks/attachments?object_id=1&project=1").respond(200, [
                id: 1,
                object_id: 1,
                project: 1,
                name: "test.txt",
        ...
        it 'should allow to delete a task attachment', inject ($model) ->
            ...
            httpBackend.expectDELETE("#{APIURL}/tasks/attachments/test").respond(200)
        ...
        it 'should allow submit the task form', inject ($model) ->
            ctrl.scope.form = {}
            ctrl.scope.issue = $model.make_model('tasks', {id: 1, ref: "1", description: "test"})
            httpBackend.expectPATCH("#{APIURL}/tasks/1", {description: "test2"}).respond(200)
